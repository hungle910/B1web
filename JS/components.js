...
<body>
   ...
   <div id="To"><h2 style="text-align: center;"> Group 1 </h2>
        ...
        <div class="ban">
            ...
            <img class="anhdaidien " src="../IMG/anhthanhvien/259855463_653888882272753_4064261298107739833_n.jpg" alt=""></div>
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/260864667_415386933635634_2642141238648471232_n.jpg" alt=""></div>
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/260178258_1332305580532413_7752996159716816287_n.jpg" alt=""></div>
        ...
        <div class="ban">
            ...
            <img class="anhdaidien"  src="../IMG/anhthanhvien/260433612_442673877370487_6210675491296601248_n.jpg" alt=""></div>
            <div class="gioithieu2"><p>Trương Lê Ngọc Duyên <br> Birth: 10/02/2005  </p></div>
            <div class="thanhvien"><h5 class="theten">Ngọc Ánh</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/260857263_1012290559319015_3145646781814782878_n.jpg" alt=""></div>
            <div class="gioithieu3"><p>Lê Thị Ngọc Ánh <br> Birth: 18/03/2005  </p></div>
            <div class="thanhvien"><h5 class="theten">Thị Hà</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/261274120_1083280915808888_4717254398421274066_n.jpg" alt=""></div>
            <div class="gioithieu4"><p>Phạm Thị Hà <br> Birth: 26/05/2005  </p></div>
        </div>

        <div class="ban">
            <div class="thanhvien"><h5 class="theten">Nguyễn Tùng</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/260064812_1529001487463820_4374407283465472885_n.jpg" alt=""></div>
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/261859608_286233490083864_3051953573331645027_n.jpg" alt=""></div>
            <div class="gioithieu3"><p>Phạm Minh Ánh <br> Birth: 11/06/2005  </p></div>
            <div class="thanhvien"><h5 class="theten">Ngọc Huyền</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/260668785_592997281948248_2772815120801560796_n.jpg" alt=""></div>
        ...
        <div class="ban">
            ...
            <img class="anhdaidien"  src="../IMG/anhthanhvien/261328986_436588457845714_4112069340125445957_n.jpg" alt=""></div>
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/261934628_1336202990150926_7284763493539931721_n.jpg" alt=""></div>
        ...
        <div class="ban">
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/261793445_478030306984011_1004420773151188178_n.jpg" alt=""></div>
        ...
        <div class="ban">
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/249359268_536712231009166_7026775707875441761_n.jpg" alt=""></div>
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/261815830_420868696338647_6894569316635634718_n.jpg" alt=""></div>
    ...
    <div id="To"><h2  style="text-align: center;"> Group 2 </h2>
        ...
        <div class="ban">
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/261793096_1872352506284710_6835786697257573543_n.jpg" alt=""></div>
            <div class="gioithieu2"><p>Trịnh Ngọc Tú Anh <br> Birth:29/04/2005 </p></div>
            <div class="thanhvien"><h5 class="theten">Ngô Phương</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/259951550_633956014307960_4875554515232511891_n.jpg" alt=""></div>
            <div class="gioithieu3"><p>Ngô Thị Phương <br> Birth: 14/07/2005 </p></div>
            <div class="thanhvien"><h5 class="theten">Khánh Huyền</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien//261157917_237951835100305_7270611722976563051_n.jpg" alt=""></div>
        ...
        <div class="ban">
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/260296419_3036259056642259_3431627266943644011_n.jpg" alt=""></div>
            <div class="gioithieu2"><p>Trịnh Hồng Liên <br> Birth: 16/02/2005 </p></div>
            <div class="thanhvien"><h5 class="theten">Yến Nhi</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/260074761_2694304484212274_9102422892868856205_n.jpg" alt=""></div>
            <div class="gioithieu3"><p>Nguyễn Yến Nhi<br> Birth: 10/2/2005  </p></div>
            <div class="thanhvien"><h5 class="theten">Thu Hà</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/261454095_299061978625067_7635848206736476059_n.gif" alt=""></div>
            <div class="gioithieu4"><p>Phạm Thu Hà <br> Birth: 14/5/2005  </p></div>
        </div>

        <div class="ban">
            <div class="thanhvien"><h5 class="theten">Tuấn Hoàn</h5>    
            <img class="anhdaidien" src="../IMG/anhthanhvien/261238883_976534286543926_3579199679814162456_n.jpg" alt=""></div>
            <div class="gioithieu" ><p>Phạm Tuấn Hoàn <br> Birth: 21/08/2005  </p></div>
            <div class="thanhvien"><h5 class="theten">Trịnh Vinh</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/260525815_303628081661136_433270060348055259_n.gif" alt=""></div>
            <div class="gioithieu2"><p>Trịnh Trí Vinh <br> Birth: 07/06/2005 </p></div>
            <div class="thanhvien"><h5 class="theten">Quang Minh</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/261178923_615021986612094_7413524943211614898_n.jpg" alt=""></div>
            <div class="gioithieu3"><p>Lê Quang Minh <br> Birth: 14/01/2005  </p></div>
            <div class="thanhvien"><h5 class="theten">Thúy Hà</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/262049602_440637134164917_8028771740715647774_n.jpg" alt=""></div>
            <div class="gioithieu4"><p>Nguyễn Thị Thúy Hà<br> Birth: 23/08/2005 </p></div>
        </div>

        <div class="ban">
            <div class="thanhvien"><h5 class="theten">Trung Anh</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/261460210_151220900549887_7937210287335214306_n.jpg" alt=""></div>
            <div class="gioithieu" ><p>Lữ Trung Anh <br> Birth: 05/10/2005 </p></div>
            <div class="thanhvien"><h5 class="theten">Bảo Tín</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/262107823_1976388669194950_8209154749578727855_n.jpg" alt=""></div>
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/262049319_868803280360731_1937194214083397436_n.jpg" alt=""></div>
            <div class="gioithieu3"><p>Nguyễn Đình Trung <br> Birth: 06/01/2005 </p></div>
            <div class="thanhvien"><h5 class="theten">Hoàng Long</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/261944527_933372340613413_8776592982251769942_n.jpg" alt=""></div>
            <div class="gioithieu4"><p>Lê Hoàng Long <br> Birth: 29/08/2005 </p></div>
        </div>

        <div class="ban">
            <div class="thanhvien"><h5 class="theten">Duy Hưng</h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/260306752_1078246139599915_9085554561607325171_n.jpg" alt=""></div>
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/260702610_325913202328230_8164824714833165579_n.jpg" alt=""></div>
            <div class="gioithieu2"><p>Trịnh Thanh Quân <br> Birth: 14/04/2005 </p></div>
            <div class="thanhvien"><h5 class="theten">Xuân Đạo </h5>
            <img class="anhdaidien" src="../IMG/anhthanhvien/262532492_1927976087396017_2140638550461865756_n.jpg" alt=""></div>
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/261871284_1096939117783935_8840720159858060180_n.jpg" alt=""></div>
        ...
        <div class="ban">
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/261414850_1253702581772894_5495647559372703923_n.jpg" alt=""></div>
            ...
            <img class="anhdaidien" src="../IMG/anhthanhvien/259234972_940183746598436_4937134762062294484_n.jpg" alt=""></div>
...
<body>
    ...
    <div class="khochuaanh">
    <img class="anh" src="../IMG/anhthanhvien/3K9A1949.JPG" alt="">
    <img class="anh" src="../IMG/Gallery/3K9A1919.JPG" alt="">
    <img class="anh" src="../IMG/Gallery/3K9A1920.JPG" alt="">
    <img class="anh" src="../IMG/Gallery/3K9A1925.JPG" alt="">
    <img class="anh" src="../IMG/Gallery/3K9A1929.JPG" alt="">
    <img class="anh" src="../IMG/Gallery/3K9A1949.JPG" alt="">
    <img class="anh" src="../IMG/Gallery/3K9A1951.JPG" alt="">
    <img class="anh" src="../IMG/Gallery/3K9A1982.JPG" alt="">
    <img class="anh" src="../IMG/Gallery/3K9A1983.JPG" alt="">
    <img class="anh" src="../IMG/Gallery/3K9A1985.JPG" alt="">
    <img class="anh" src="../IMG/Gallery/3K9A1986.JPG" alt="">
    <img class="anh" src="../IMG/Gallery/3K9A2019.JPG" alt="">
    <img class="anh" src="../IMG/Gallery/3K9A2020.JPG" alt="">
